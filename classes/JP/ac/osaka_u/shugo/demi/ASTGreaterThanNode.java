/* Generated By:JJTree: Do not edit this line. ASTGreaterThanNode.java */

package JP.ac.osaka_u.shugo.demi;

public class ASTGreaterThanNode extends SimpleNode {
    public ASTGreaterThanNode(int id) {
	super(id);
    }

    public ASTGreaterThanNode(Parser p, int id) {
	super(p, id);
    }
