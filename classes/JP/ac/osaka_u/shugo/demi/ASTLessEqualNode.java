/* Generated By:JJTree: Do not edit this line. ASTLessEqualNode.java */

package JP.ac.osaka_u.shugo.demi;

public class ASTLessEqualNode extends SimpleNode {
    public ASTLessEqualNode(int id) {
	super(id);
    }

    public ASTLessEqualNode(Parser p, int id) {
	super(p, id);
    }
