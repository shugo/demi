/* Generated By:JJTree: Do not edit this line. ASTPreDecNode.java */

package JP.ac.osaka_u.shugo.demi;

public class ASTPreDecNode extends SimpleNode {
    public ASTPreDecNode(int id) {
	super(id);
    }

    public ASTPreDecNode(Parser p, int id) {
	super(p, id);
    }

    public static Node jjtCreate(int id) {
	return new ASTPreDecNode(id);
    }

    public static Node jjtCreate(Parser p, int id) {
	return new ASTPreDecNode(p, id);
    }
